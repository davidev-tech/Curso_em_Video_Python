# =============================================================================================
# DESAFIO 108: Processar dados usando modulo.
...
print(f'O preco de {moedas.formatar_preco(preco)} aumentado em {moedas.formatar_preco(taxa_aumento)}% é {moedas.formatar_preco(moedas.aumentar_porcentagem_valor(preco, taxa_aumento))}')
print(f'O preco de {moedas.formatar_preco(preco)} reduzido em {moedas.formatar_preco(taxa_reduzir)}% é {moedas.formatar_preco(moedas.reduzir_porcentagem_valor(preco, taxa_reduzir))}')